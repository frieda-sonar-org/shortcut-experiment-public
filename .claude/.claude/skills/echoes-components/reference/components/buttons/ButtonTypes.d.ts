import { ButtonHTMLAttributes, MouseEvent } from '../../../node_modules/react';
export type HTMLButtonAttributesSubset = Pick<ButtonHTMLAttributes<HTMLButtonElement>, 'form' | 'name' | 'role' | 'type'>;
