 ...
 */
export type PropsWithLabelsAndHelpText<T> = T & (PropsLabelAndHelpText | PropsAriaLabelAndHelpText | PropsAriaLabelledByAndHelpText | PropsAriaLabelViaIdAndHelpText);
/**
 ...
 * @template T - The base props interface to extend with labeling capabilities
 */
export type PropsWithLabels<T> = T & (PropsLabel | PropsAriaLabel | PropsAriaLabelledBy | PropsAriaLabelViaId);
