      ...
      <Layout.GlobalNavigation.Secondary>
        ...
        >
          <svg width="97" height="32" viewBox="0 0 97 32" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <defs>
              <linearGradient id="sqc-upg-border" x1="0" y1="16" x2="96" y2="16" gradientUnits="userSpaceOnUse">
                <stop stopColor="#FF84DA"/>
                <stop offset="1" stopColor="#B7A6FF"/>
              </linearGradient>
              <linearGradient id="sqc-upg-text" x1="30" y1="16" x2="88" y2="16" gradientUnits="userSpaceOnUse">
                <stop stopColor="#FF84DA"/>
                <stop offset="1" stopColor="#B7A6FF"/>
              </linearGradient>
              <mask id="sqc-upg-clip" maskUnits="userSpaceOnUse" x="8" y="8" width="16" height="16">
                <rect x="8" y="8" width="16" height="16" fill="white"/>
              </mask>
              <mask id="sqc-upg-icon" maskUnits="userSpaceOnUse" x="9" y="10" width="14" height="12">
                <g mask="url(#sqc-upg-clip)">
